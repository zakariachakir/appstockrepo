...
//table1
    ...
    public void Addtosales(ActionEvent evt) throws SQLException {
        if (txtcodeproduit.getText().equals("") || txtref.getText().equals("") || txtstocksortie.getText().equals("") || txtfournisseur.getText().equals("")
            ...
            JOptionPane.showMessageDialog(null, "Please provide a Bill number");
        } else {
    ...
    public void payeapres() {
        ...
        if (c >= 0) {
            ...
            labelReste.setText("TO PAY AFTER     :");
        } else if (c < 0) {
            reste.setText(Integer.toString(c * -1));
            labelReste.setText("TO BE RETURNED   :");
        } 
    }
    ...
    public void Deleteselected(ActionEvent evt) throws SQLException {
        ...
        String code_produit = String.valueOf(p.getCode_produit());
        int stocksortie = p.getStock_sortie();
